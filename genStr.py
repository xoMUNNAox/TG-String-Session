...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@String_Sessions_generator_robot](tg://openmessage?user_id=1613598498) \nA Bot By @SEDxD")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/X_F0RCE_TEAM'),
                InlineKeyboardButton('Developer', url='https://t.me/SEDXD')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/X_F0RCED'),
            ]
        ]
    )
